...
`server/.env`:
```
HEYGEN_API_KEY=sk_V2_hgu_kyGMrTiJ6An_otozOuVsgt3dByoUGZXZbBBMSRWJ0YqD
CLEO_AVATAR_ID=dff8b7bb77bd4c13ab6a837104163a01
GOOGLE_TTS_API_KEY=AIzaSyB8A16IK8_SmIG-VY4no_69MNiXWSzMMow
GEMINI_API_KEY=AIzaSyC_2VuP5VsZ7a9P4DE5CE1zqzIkHly4tSc
GENIUS_ACCESS_TOKEN=K6s6CVjnlIj7o5todKnwjexyLOx2xYtVrwjWht8SWwqwoDmZyJpSeNL7C9C7cDI_
PORT=3001
```
