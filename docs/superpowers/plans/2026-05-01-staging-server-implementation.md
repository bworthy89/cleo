...
**Where:** SSH into the VPS as `cleo@187.124.69.95`.
...
- [ ] Check VPS: `ssh cleo@187.124.69.95 'pm2 logs cleo-broadcast-staging --lines 50'` should show the bake's log lines (`[bake id=... user=...] start vibe=... length=quick`).
